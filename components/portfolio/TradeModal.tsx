    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Trade {coinSymbol.toUpperCase()}</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-between text-sm text-gray-500 mt-1">
              <span>Max: {action === 'BUY' ? maxBuy.toFixed(8) : maxSell.toFixed(8)} {coinSymbol.toUpperCase()}</span>
              <button
                type="button"
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-4 space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Trading Fee ({orderType === 'market' ? 'Taker' : 'Maker'}):</span>
          ...
          <div className="bg-blue-50 rounded-lg p-3 mb-6 space-y-1">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{userHoldings.toFixed(8)} {coinSymbol.toUpperCase()}</span>
            </div>
          </div>
